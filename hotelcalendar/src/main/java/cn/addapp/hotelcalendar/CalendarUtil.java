...
final class CalendarUtil {
     ...
     */
    static boolean isWeekend(CustomCalendar calendar) {
...
//    }
     ...
     */
//    static int getWeekFromDayInMonth(CustomCalendar calendar, int weekStart) {
//        java.util.Calendar date = java.util.Calendar.getInstance();
...
//    }
     ...
     * @return 获取上一个日子
     */
    static CustomCalendar getPreCalendar(CustomCalendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        CustomCalendar preCalendar = new CustomCalendar();
    ...
    static CustomCalendar getNextCalendar(CustomCalendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        CustomCalendar nextCalendar = new CustomCalendar();
...
//    }
     ...
     * @return 返回某个日期是星期几
     */
    static int getWeekFormCalendar(CustomCalendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        date.set(calendar.getYear(), calendar.getMonth() - 1, calendar.getDay());
     ...
     */
    static int getWeekViewIndexFromCalendar(CustomCalendar calendar, int weekStart) {
     ...
     * @return 是否在日期范围內
     */
    static boolean isCalendarInRange(CustomCalendar calendar,
     ...
     */
    static int getWeekFromCalendarStartWithMinCalendar(CustomCalendar calendar,
                                                       int minYear, int minYearMonth, int minYearDay,
                                                       int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 该星期的第一天日期
     */
    static CustomCalendar getFirstCalendarStartWithMinCalendar(int minYear, int minYearMonth, int minYearDay, int week, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
...
//    }
     ...
     */
    static int differ(CustomCalendar calendar1, CustomCalendar calendar2) {
        if (calendar1 == null) {
    ...
    static int compareTo(int minYear, int minYearMonth, int minYearDay,
                         int maxYear, int maxYearMonth, int maxYearDay) {
        CustomCalendar first = new CustomCalendar();
        first.setYear(minYear);
        first.setMonth(minYearMonth);
        first.setDay(minYearDay);

        CustomCalendar second = new CustomCalendar();
     ...
     * @return 为月视图初始化日历项
     */
//    static List<CustomCalendar> initCalendarForMonthView(int year, int month, CustomCalendar currentDate, int weekStar) {
//        java.util.Calendar date = java.util.Calendar.getInstance();
//
//        date.set(year, month - 1, 1);
//
...
//        int size = 42;
//
//        List<CustomCalendar> mItems = new ArrayList<>();
//
...
//            CustomCalendar calendarDate = new CustomCalendar();
//            if (i < mPreDiff) {
...
//    static List<CustomCalendar> getWeekCalendars(CustomCalendar calendar, CalendarViewDelegate mDelegate) {
