...
public final class CustomCalendar implements Serializable {
     ...
     * 获取完整的农历日期
     */
    private CustomCalendar lunarCalendar;
    ...
    public CustomCalendar getLunarCalendar() {
        return lunarCalendar;
    }

    public void setLunarCalendar(CustomCalendar lunarCakendar) {
     ...
     * @return 是否是相同月份
     */
    public boolean isSameMonth(CustomCalendar calendar) {
     ...
     * @return -1 0 1
     */
    public int compareTo(CustomCalendar calendar) {
        if (calendar == null) {
            return 1;
        }
     ...
     * @return 运算差距多少天
     */
//    public final int differ(CustomCalendar calendar) {
...
//    }
    ...
    public boolean equals(Object o) {
        if (o != null && o instanceof CustomCalendar) {
            if (((CustomCalendar) o).getYear() == year && ((CustomCalendar) o).getMonth() == month && ((CustomCalendar) o).getDay() == day)
                return true;
        }
    ...
    final void mergeScheme(CustomCalendar calendar, String defaultScheme) {
        if (calendar == null)
            return;
