...
final class LunarCalendar {
     ...
     */
    static void setupLunarCalendar(CustomCalendar calendar) {
        ...
        CustomCalendar lunarCalendar = new CustomCalendar();
     ...
     * @return 获取农历节日
     */
    static String getLunarText(CustomCalendar calendar) {
