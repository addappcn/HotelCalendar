...
//      calendar.setMonth(month.getMonth());
//      calendar.setDay(today.getFirstDayOfWeek());
      ...
      case RANGE:
        if (selectedCals.size() > 1) {
          ...
          clearOldSelections();
            ...
            // 解决多次选择同一天为范围开始时间时  再选择后面的时间时 应该为范围结束时间 结果为范围开始时间 所以要清除下之前的选中
            clearOldSelections();
        }
        break;
